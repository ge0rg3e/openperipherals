	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/70 aria-expanded:bg-secondary/70 aria-expanded:text-secondary-foreground",
